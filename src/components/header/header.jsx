    ...
    return (
        <header className="header">
            <nav className="nav container">
                <a href="index.html" className="nav__logo">Sina</a>
                ...
                <div className={Toggle ? "nav__menu show-menu" : "nav__menu"}>
                    <ul className="nav__list grid">
                        ...
                        <li className="nav__item">
                            ...
                            className={activeNav === "#publication" ?
                            "nav__link active-link" : "nav__link"}
                            >
                                <i className="uil uil-book-alt nav__icon"></i> Publication
                            </a>
                        </li>
                        ...
                        <li className="nav__item">
                            ...
                            className={activeNav === "#freelance" ?
                            "nav__link active-link" : "nav__link"}
                            >
                                <i className="uil uil-briefcase-alt nav__icon"></i> Freelancing
                            </a>
                        </li>
